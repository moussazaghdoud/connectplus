 ...
 *
 * CRM operations (lookup, call logging) go through CrmService,
 * which uses ConnectorRegistry as the single source of truth.
 * No connector-specific wiring here.
 *
...
export async function register() {
  ...
  console.log("[ConnectPlus] Instrumentation complete — CRM operations routed via CrmService");
}
